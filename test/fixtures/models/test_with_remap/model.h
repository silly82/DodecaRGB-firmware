...
// Generated on: 2025-06-18 00:23:52
// Generated using: generate_model.py -d test/fixtures/models/test_with_remap -y
...
// Simple pyramid model with face remapping for testing
struct PyramidWithRemap : public ModelDefinition<12, 4> {

    // Required metadata
    static constexpr const char* NAME = "PyramidWithRemap";
    static constexpr const char* VERSION = "1.0";
    static constexpr const char* DESCRIPTION = "Simple pyramid model with face remapping for testing";
    static constexpr const char* MODEL_TYPE = "Pyramid";
    static constexpr const char* GENERATED_DATE = "2025-06-18 00:23:52";
    ...
    static constexpr std::array<FaceData, FACE_COUNT> FACES{{
        ...
        {.id = 1, .type_id = 0, .rotation = 0, .geometric_id = 3,
            .vertices = {
        ...
        {.id = 2, .type_id = 0, .rotation = 0, .geometric_id = 0,
            .vertices = {
        ...
        {.id = 3, .type_id = 0, .rotation = 0, .geometric_id = 1,
            .vertices = {
    ...
    static constexpr PointData POINTS[] = {
        {0, 0, 267.432f, -224.419f, 50.994f},
        {1, 0, 274.826f, -191.972f, 36.208f},
        {2, 0, 282.220f, -159.525f, 21.421f},
        {3, 1, 296.076f, 184.993f, 50.994f},
        {4, 1, 267.502f, 202.052f, 36.208f},
        {5, 1, 238.928f, 219.112f, 21.421f},
        {6, 2, -74.001f, 224.419f, 262.000f},
        {7, 2, -90.534f, 191.972f, 262.000f},
        {8, 2, -107.066f, 159.525f, 262.000f},
        {9, 3, -86.815f, -184.983f, 287.626f},
        {10, 3, -87.262f, -202.042f, 255.456f},
        {11, 3, -87.708f, -219.102f, 223.287f}
    };
